...
public class StoreStepdefs {
    ...
    static String name = "clo" + TestUtils.getRandomValue();
    static String type = "SmallBox";
    static String address = "0140 Huxley Avenue";
    static String address2 = "Apt 1987";
    static String city = "Catujal";
    static String state = "Lisboa";
    static String zip = "2680-333";
    static double lat = 38.8091524;
    static double lng = -9.1166554;
